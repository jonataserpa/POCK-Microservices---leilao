        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-300 text-sm">
              Plataforma premium de leilões automotivos.
            </p>
          </div>
          <div>
...
export function CampaignCard({
  ...
  const endDate = campaign.validUntil
    ...
    <div className="group bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-50">
          ...
          <a
            href={detailUrl}
            className="bg-gray-900 hover:bg-purple-600 text-white text-sm font-medium py-2.5 px-6 rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg"
          >

    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h1 className="text-2xl font-bold text-gray-900">Configurações do Portal</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card className="p-6">
                    <h2 className="text-lg font-semibold mb-4 text-purple-700">Aparência do Cabeçalho</h2>
                ...
                <Card className="p-6">
                    <h2 className="text-lg font-semibold mb-4 text-purple-700">Identidade Visual</h2>

                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Título do Portal</label>
                            <Input
                                value={titleText}
